...
local function carregarRecursos()
    ...
    volume = math.floor(love.audio.getVolume() * 100 + 0.5)
end
...
function pausa.update(dt)
    ...
    local btnW = 340
    local btnH = 54 -- Slightly taller for RPG design proportions
...
function pausa.draw()
    ...
    love.graphics.printf("SINTONIA DE VOLUME: " .. volume .. "%", panelX + 1, panelY + 373, panelW, "center")
    -- Text gold color
    love.graphics.setColor(0.85, 0.70, 0.45, 1.0)
    love.graphics.printf("SINTONIA DE VOLUME: " .. volume .. "%", panelX, panelY + 372, panelW, "center")
